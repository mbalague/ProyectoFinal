        ...
        <div class="col-md-10">
			...
			<div class="card pub_image pub_image_detail">
				...
				<div class="card-body">
					...
					<!-- Descripcion de la imagen con el formato de la fecha y el nick del usuario-->
					...
					<!--Edicion de las imagenes de un usuario-->
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										Si la eliminas, perderás tu foto,¿estás seguro?
									</div>
					...
					<div class="comments">
						...
						<form method="POST" action="{{ route('comment.save') }}">
							...
							<p>
								<!--Errores en el formulario de los comentarios-->
						...
						<!--Mostramos contenido del comentario-->
						<div class="comment">
